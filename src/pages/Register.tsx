                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          placeholder={String(selectedPlan.minCapital)}
                      ...
                      {investedAmount && Number(investedAmount) >= selectedPlan.minCapital && (
                        <p className="text-[#1E7A47] text-xs mt-1.5 font-medium">
                          Recibirías: ${(Number(investedAmount) * (1 + selectedPlan.returnRate / 100)).toFixed(0)} al terminar el plan
                        </p>
                      )}
                    </div>
                  )}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="Dirección de tu billetera (te ayudamos a crearla si no tienes)"
                      className={inputClass + ' font-mono text-xs'}
                    />
                    <p className="text-[#B8B4AF] text-[11px] mt-1.5">
                      Al terminar tu plan, enviamos tu capital + ganancias a esta dirección.
                      Si no tienes una billetera aún, escríbenos y te ayudamos.
                    </p>
                  </div>
                  ...
                  <div className="flex gap-3">
                    <button type="button" onClick={() => setStep(1)} className="px-5 py-3 rounded-xl border border-black/[0.08] text-[#6B6862] text-sm hover:border-black/[0.15] hover:text-[#1A1918] transition-colors">
                      Atrás
                    </button>
